...
jQuery(document).ready(function($){
	...
	$('#demo_installation').click(function() {
		...
		//confirm reset
		var answer = confirm("CAUTION! This will install the PortalWP theme demo content! Make sure you've successfully completed previous stepes and you're installing the demo content on a clean Wordpress installation! If you have any posts/pages/content, they will get replaced with the demo posts!");
		...
		if (answer){
			...
			$.post(ajaxurl, data, function(response) {
				...
				if (response==1)
				{
					alert('PortalWP Demo Content installed successfully! Have fun!');
					window.setTimeout(function(){
						location.reload();
					}, 1000);
				} 
				...
				{ 
					alert('Demo installation has failed! Contact us at support.shindiristudio.com or via email support@shindiristudio.com to help you with the install.')
					window.setTimeout(function(){
						fail.fadeOut();
					}, 2000);
				}
